import argparse
import sys
from examples.collect_trajectories_from_checkpoint import main
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_dir', default='', help='checkpoint directory', type=str)
    parser.add_argument('--num_traj_to_collect', default=1, help='number of trajectories to collect', type=int)
